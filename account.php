...
<?php 
	...
	$query2 = mysqli_query($con,"SELECT * FROM posts");
	...
	<div class="row">
		...
		<div class="col-7 pt-3">
			<div class="col-12 border-bottom" >
				<h5><!--Здесь вывести имя и фамилию авторизованного пользователя--><?php echo $stroka["name"].' '.$stroka["surname"] ?></h5>
				<p class="text-secondary">Изменить статус</p>
				<p class="text-secondary">День рождения <?php echo $stroka["day"] ?></p>
				<p class="text-secondary">Город <?php echo $stroka["city"] ?></p>
				<p class="text-secondary">Образование <?php echo $stroka["education"] ?></p>

				
			</div>
			<div class="col-12">
				<form action="insert.php" method="GET">
					<input type="" name="text" placeholder="Введите текст"  class="form-control">
					<p class="mt-2 ml-2"><input type="file" name="img" multiple accept="image/*,image/jpeg,image/png" >
					<button class="btn bg-secondary">Что у вас нового?</button>
				</form>
			</div>
		 		...
		 		//цикл начинается
			 		...
			 		<div class="row">
			 			<div class="col-2">
			 				...
			 				<img src="<?php echo $stroka["avatar"] ?>" class = "w-100 rounded-circle">
