...
<?php 
	...
	$query2 = mysqli_query($con, "SELECT * FROM posts INNER JOIN users ON posts.users_id = users.id WHERE users.id = '{$_SESSION["id"]}'");  
?>
	<!--шапка сайта-->
	...
	<div class="row">
		...
		<div class="col-4 p-5">
			<div class="col-12 bg-white p-3">
				...
				<p class="text-danger"><?php echo $_GET['nothing'] ?></p>
			</div>
		</div>
	</div>
</div>
